        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="border-l-2 border-emerald-500 pl-4">
              <p className="text-sm font-semibold text-slate-200 mb-1">Publishing Companies</p>
              <p className="text-xs text-slate-500 mb-3 leading-relaxed">
                Catalog dry-cleaning, CWR preflight, split verification, and PRO reconciliation tools.
              </p>
              <Link href="/publisher-portal" className="text-xs text-emerald-400 hover:text-emerald-300 transition">
                Publishing portal →
              </Link>
            </div>
