...
function RoyaltyFinderContent() {
  ...
  // Demo mode: immediately show mock result, no API call needed
  useEffect(() => {
    if (demoMode) {
      setSearchType('isrc');
      setIsrc(DEMO_ISRC);
      ...
      // Switched to live — clear demo results
      if (results === DEMO_ROYALTY_RESULT) {
        setResults(null);
        setIsrc('');
      }
    }
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          ...
          <div className="bg-[#0f172a] p-6 rounded-xl shadow-sm border border-white/10">
            ...
            <p className="text-slate-300">
              Pull real ISRCs from SMPT to verify neighboring rights and Rights Administrator claims.
            </p>
          </div>
          <div className="bg-[#0f172a] p-6 rounded-xl shadow-sm border border-white/10">
            <div className="text-3xl mb-3">💰</div>
