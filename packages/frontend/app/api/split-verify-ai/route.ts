...
export async function POST(request: Request) {
  try {
    ...
    // --- Rule-based analysis (always works, instant) ---
    const issues: any[] = [];
    ...
    // Try Ollama for enhanced forensic summary (best-effort, 30s timeout)
    try {
      ...
      // Ollama unavailable — rule-based summary already set
    }
