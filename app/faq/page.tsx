    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="bg-indigo-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-indigo-200 mb-8">Everything you need to know about TrapRoyaltiesPro</p>
          {/* Search */}
          <div className="max-w-xl mx-auto relative">
            <input
              ...
              className="w-full px-6 py-4 pr-12 rounded-2xl text-gray-900 text-lg shadow-xl focus:outline-none focus:ring-4 focus:ring-indigo-300"
            />
              ...
              {CATEGORIES.map(cat => (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-3 rounded-xl whitespace-nowrap font-medium transition-all duration-200 hover:scale-105 text-sm ${
                    activeCategory === cat.id ? 'cat-active' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                  }`}
                >
                  <span>{cat.icon}</span>
                  {cat.label}
            ...
            {searchResults.length === 0 ? (
              ...
              <div className="space-y-4">
                {searchResults.map((r, ri) => (
                  <div key={ri} className="faq-item bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                    <div className="px-6 py-3 bg-indigo-50 border-b border-indigo-100 flex items-center gap-2">
                      ...
                      <span className="text-xs font-semibold text-indigo-600 uppercase tracking-wide">{r.catLabel}</span>
                    </div>
                    <div className="p-6">
                      <h3 className="text-lg font-bold text-gray-900 mb-3">{r.q}</h3>
                      <p className="text-gray-600 leading-relaxed">{r.a}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <>
            ...
            <div className="mb-8 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">{items.length} questions</p>
              </div>
              <button
                onClick={() => {
                ...
                className="ml-auto text-xs text-indigo-600 hover:text-indigo-800 font-medium underline"
              >
            ...
            <div className="space-y-4">
              {items.map((item, i) => {
                ...
                return (
                  <div
                    key={key}
                    className={`faq-item bg-white rounded-2xl shadow-md border transition-all duration-200 overflow-hidden ${
                      isOpen ? 'border-indigo-200 shadow-lg' : 'border-gray-100'
                    }`}
                  ...
                  >
                    ...
                    >
                      <span className="font-semibold text-gray-900 text-base pr-4 leading-snug">{item.q}</span>
                      <span
                        className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center font-bold text-lg transition-all duration-300 ${
                          isOpen ? 'bg-indigo-600 text-white rotate-45' : 'bg-gray-100 text-gray-400'
                        }`}
                      >
                        +
                      </span>
        ...
        <div className="mt-16 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-10 text-white text-center shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="px-8 py-4 bg-white text-indigo-600 rounded-xl font-bold hover:bg-gray-100 transition duration-200 hover:scale-105"
            >
              Email Support
            </a>
            <Link
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <Link
              key={link.href}
              href={link.href}
              className="bg-white rounded-xl p-5 text-center shadow-md border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 group"
            >
